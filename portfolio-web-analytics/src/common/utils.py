...
from src.core.errors import ProjectUtilsError


class ProjectUtils(BaseClass):
    """Classe de utilitários do projeto."""

    def __init__(self, start_dir: PathLike | None = None):
    ...
    def find_project_root(self) -> Path:
        ...
        try:
            for parent in Path(self.start_dir).parents:
                if (parent / "pyproject.toml").exists():
                    return parent
            return Path("./").resolve()
        except ProjectUtilsError:
            self.logger.exception("Erro ao encontrar o diretório raiz do projeto.")
            raise
    ...
    def create_gitkeep_for_empty_dirs(self) -> None:
        ...
        try:
            ...
            self.logger.exception("Erro ao criar arquivos .gitkeep em diretórios vazios.")
            raise
    ...
    def execution_time(self, *, beep: bool = False) -> None:
        ...
        try:
            ...
            self.logger.exception("Erro ao calcular o tempo de execução.")
            raise
